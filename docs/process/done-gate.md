...
8c. **Navigation verification** — if this item adds or modifies screens/pages, verify that navigation between the screens (routing, state transitions, back buttons, deep linking) is correctly implemented and visually tested.
