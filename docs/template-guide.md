...
| `.agents/skills/*/SKILL.md` | 30 workflow skills/commands |
...
- **Knowledge Items:** Antigravity learns across sessions automatically. You can explicitly trigger this using the `/learn` slash command.
...
| `schedule` | Run commands in the background on a schedule or timer |
