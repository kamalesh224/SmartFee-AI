// agent-notes: { ctx: "App header bar with branding for Vaigai College of Engineering (Anna University)", deps: ["src/types.ts"], state: active, last: "antigravity@2026-08-15" }
